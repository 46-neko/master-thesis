...
python -u -m torch.distributed.launch \
    ...
    --use_ema \
    --pretrained_encoder /nas.dbms/benedetti/master/LW-DETR/pretrain_weights/caev2_small_300e_objects365.pth \
    --pretrain_weights /nas.dbms/benedetti/master/LW-DETR/pretrain_weights/LWDETR_medium_30e_objects365.pth \
