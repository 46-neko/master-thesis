model_name='lwdetr_xlarge_coco'
coco_path=$1

python -u -m torch.distributed.launch \
    --nproc_per_node=1 \
    --use_env \
    /nas.dbms/benedetti/master/LW-DETR/main.py \
    --lr 1e-4 \
    --lr_encoder 1.5e-4 \
    --batch_size 1 \
    --weight_decay 1e-3 \
    ...
    --use_ema \
    --pretrained_encoder /nas.dbms/benedetti/master/LW-DETR/pretrain_weights/caev2_base_300e_objects365.pth \
    --pretrain_weights /nas.dbms/benedetti/master/LW-DETR/pretrain_weights/LWDETR_xlarge_30e_objects365.pth \
    ...
    --output_dir /nas.dbms/benedetti/master/LW-DETR/output/$model_name
