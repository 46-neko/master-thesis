...
"""
import sys
sys.path.append('home/algorithm-lab-xps/master-thesis/LW-DETR')
print(sys.path)
...
# COCO classes
COCO_CLASSES = [
    'PCB', 'missing_hole', 'mouse_bite', 'open_circuit', 'short', 'spur', 'spurious_copper'
]
...
def visualize_detections(image, boxes, labels, scores, conf_thresh, output_path):
    ...
    for box, label, score in zip(boxes, labels, scores):
        if score > conf_thresh:
            ...
            draw.text((xmin, ymin - 30), text, fill="red", font=font)
